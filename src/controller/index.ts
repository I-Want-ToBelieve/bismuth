...
export class ControllerImpl implements Controller {
  ...
  private bindTrayActions(): void {
    // TODO: move qml access to driver via Action.
    // TODO: introduce toggle floating layout action
    // TODO: prevent spawn of menu
    // TODO: test Wayland
    this.qmlObjects.trayItem.menu.onToggleTiling = (): void => {
      const action = new Action.SetFloatingLayout(this.engine, this.log);
      action.execute();
    };
  }
